...
// compute_XtXw_Xtrw_cpp
Rcpp::List compute_XtXw_Xtrw_cpp(Eigen::ArrayXd& alphaGrid, Eigen::ArrayXd& FT_r_wseq, Eigen::ArrayXd& wseq, Eigen::ArrayXd& phi_wseq);
RcppExport SEXP _momentLS_compute_XtXw_Xtrw_cpp(SEXP alphaGridSEXP, SEXP FT_r_wseqSEXP, SEXP wseqSEXP, SEXP phi_wseqSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(compute_XtXw_Xtrw_cpp(alphaGrid, FT_r_wseq, wseq, phi_wseq));
    return rcpp_result_gen;
END_RCPP
}
